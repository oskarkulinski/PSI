...
for i in range(100):
    ...
    m1.append(np.mean(r1))
    m2.append(np.mean(r2))
    m3.append(np.mean(r3))
    m4.append(np.mean(r4))
    m5.append(np.mean(r5))
    m6.append(np.mean(r6))
    m7.append(np.mean(r7))
...
plt.plot(x_plot, m1, color='red',linewidth=3, label='1')
plt.plot(x_plot, m2, color='green',linewidth=3, label='2')
plt.plot(x_plot, m3, color='yellow',linewidth=3, label='3')
plt.plot(x_plot, m4, color='brown',linewidth=3, label='4')
plt.plot(x_plot, m5, color='blue',li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newidth=3, label='5')
plt.plot(x_plot, m6, color='orange',linewidth=3, label='6')
plt.plot(x_plot, m7, color='purple',linewidth=3, label='7')
plt.legend()
plt.show()
